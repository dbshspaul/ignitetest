...
public class Rate {
    ...
    public String getStay_String() {
        return stay_String;
    }

    public void setStay_String(String stay_String) {
        this.stay_String = stay_String;
    }
